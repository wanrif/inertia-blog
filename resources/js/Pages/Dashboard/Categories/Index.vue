...
const editModal = (category) => {
    data.editModal = category;
};

const deleteModal = (category) => {
    data.deleteModal = category;
};
</script>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                @click="createOpenModal = !createOpenModal"
                        ...
                        <CreateModal
                            ...
                            @close="createOpenModal = false"
                        />

                        <EditModal
                            title="Edit Category"
                            :category="data.editModal"
                            @close="data.editModal = null"
                        />

                        <DeleteModal
                            title="Delete Category"
                            body="Are you sure you want to delete this category?"
                            :slug="data.deleteModal"
                            @close="data.deleteModal = null"
                        />
