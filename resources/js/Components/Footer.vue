...
<template>
    <!-- component -->
    <footer
        class="mt-5 bg-gradient-to-r from-gray-100 dark:from-gray-900 via-cyan-200 dark:via-cyan-900 to-gray-100 dark:to-gray-900"
    >
        <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                    <ApplicationLogo class="w-10 h-10 fill-cyan-500" />
                    <p
                ...
                >
                    <div>
                        <p class="font-medium dark:text-gray-100">Company</p>
                        <nav
                            class="flex flex-col mt-4 space-y-2 text-sm text-gray-500 dark:text-gray-100"
                        >
                    ...
                    <div>
                        <p class="font-medium dark:text-gray-100">Services</p>
                        <nav
                            class="flex flex-col mt-4 space-y-2 text-sm text-gray-500 dark:text-gray-100"
                        >
                    ...
                    <div>
                        <p class="font-medium dark:text-gray-100">Legal</p>
                        <nav
                            class="flex flex-col mt-4 space-y-2 text-sm text-gray-500 dark:text-gray-100"
                        >
                            <a class="hover:opacity-75" href>
